...
const rules={
    username:[
        ...
        { min:5, max:16, message:'用户名长度是5-16个字符', trigger:'blur' }
    ],
    password:[
        { required:true, message:'请输入密码', trigger:'blur' },
        { min:5, max:16, message:'密码长度是5-16个字符', trigger:'blur' }
    ],
    rePassword:[
...
.login-page {
    ...
    .bg::before {
        ...
        top: 25%; /* 垂直居中 */
        left: 65%; /* 根据你原来背景图像的位置调整 */
        transform: translate(-50%, -50%); /* 确保文本居中 */
        font-size: 90px; /* 文本大小，可根据需要调整 */
